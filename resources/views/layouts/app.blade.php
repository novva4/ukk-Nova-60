...
<body>
            ...
            <nav class="sidebar-nav">
                @if (Auth::user()->role === 'admin')
                    ...
                    <a href="{{ route('books.index') }}"
                        class="nav-link-custom {{ request()->routeIs('books.*') ? 'active' : '' }}">
                    ...
                    <a href="{{ route('admin.transactions.index') }}"
                        class="nav-link-custom {{ request()->routeIs('admin.transactions.*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                @else
                    ...
                    <a href="{{ route('user.catalog') }}"
                        class="nav-link-custom {{ request()->routeIs('user.catalog') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-book-icon lucide-book">
                            <path
                    ...
                    <a href="{{ route('user.transactions.history') }}"
                        class="nav-link-custom {{ request()->routeIs('user.transactions.*') ? 'active' : '' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="lucide lucide-clipboard-clock-icon lucide-clipboard-clock">
                            <path d="M16 14v2.2l1.6 1" />
        ...
        <div class="main-wrapper">
            <div class="topbar">
                ...
                <div class="topbar-right">
                    <span
                        style="font-size:12px; color:var(--text-muted);">{{ now()->isoFormat('dddd, D MMMM YYYY') }}</span>
                </div>
            </div>
    ...
    @else
        ...
        <div style="min-height:100vh; background: var(--bg-body);">
            <nav
                style="background:var(--white); border-bottom:1px solid var(--border); padding: 0 32px; height:64px; display:flex; align-items:center; justify-content:space-between; position:sticky; top:0; z-index:100;">
